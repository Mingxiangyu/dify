    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: '帮助访问者了解该应用收集的数据，可参考 DAOSMOS 的<privacyPolicyLink>隐私政策</privacyPolicyLink>。',
      ...
      embedded: {
        ...
        chromePlugin: '安装 DAOSMOS Chrome 浏览器扩展',
        copied: '已复制',
        copy: '复制',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: 'DAOSMOS-WebClient',
          step2: '部署到 Vercel 中',
