const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'DAOSMOS-Konto',
    langGeniusAccountTip: 'Ihr DAOSMOS-Konto und zugehörige Benutzerdaten.',
  ...
  apiBasedExtension: {
    ...
    linkUrl: 'https://daosmos.agent.ai/features/extension/api_based_extension',
