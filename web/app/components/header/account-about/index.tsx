      ...
      <div className='relative pt-4'>
        ...
        <div>
          ...
          <div className='mb-4 text-center text-xs font-normal text-gray-700'>
            <div>© {dayjs().year()} DAOSMOS, Inc., Contributors.</div>
            <div className='text-[#1C64F2]'>
              {
                IS_CE_EDITION
                  ? <Link href={'https://github.com/langgenius/daosmos/blob/main/LICENSE'} target='_blank' rel='noopener noreferrer'>Open Source License</Link>
                  : <>
        ...
        <div className='flex justify-between items-center'>
          ...
          <div className='flex items-center'>
            <Link
              ...
              href={'https://github.com/langgenius/daosmos/releases'}
